...
class PetWhisperController extends Controller
{
    /**
     * 獲取寵物的隨機小語
     * 
     ...
     * @return JsonResponse
     */
    public function getRandomWhisper(Request $request): JsonResponse
    {
        ...
        // 獲取隨機小語
        $whisper = PetWhisper::getRandomWhisper($petId);
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'whisper' => [
                    ...
                    'is_default' => is_null($whisper->pet_id)
                ]
            ]
        ]);
    }
     ...
     * @return JsonResponse
     */
    public function getPetWhispers(Request $request): JsonResponse
    {
        $petId = $request->input('pet_id');
        $lineUserId = $request->input('line_user_id');
        ...
        // 獲取所有小語
        $whispers = PetWhisper::getPetWhispers($petId);
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'pet_name' => $pet->pet_name,
                'pet_image' => $petImage,
                'whispers' => $whispers->map(function ($whisper) {
                    return [
